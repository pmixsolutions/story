...
use Closure;
use Pmixsolutions\Support\Str;
use Illuminate\Support\Manager;
use Pmixsolutions\Story\Parsers\Plain;
use Pmixsolutions\Story\Parsers\Markdown;
...
class FormatManager extends Manager
{
     ...
     *
     * @return \Pmixsolutions\Story\Parsers\Markdown
     */
    ...
    {
        return $this->app['config']->get('pmixsolutions/story::config.default_format', 'markdown');
    }
}
