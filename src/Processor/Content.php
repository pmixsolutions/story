...
namespace Pmixsolutions\Story\Processor;

use Carbon\Carbon;
use Orchestra\Foundation\Processor\Processor;
use Illuminate\Contracts\Auth\Authenticatable;
use Pmixsolutions\Story\Model\Content as Eloquent;
use Pmixsolutions\Story\Validation\Content as Validator;
...
class Content extends Processor
{
     ...
     *
     * @param  \Pmixsolutions\Story\Validation\Content  $validator
     ...
     * Store new content.
     *
     * @param  \Pmixsolutions\Story\Contracts\Listener\Content  $listener
     * @param  array  $input
     *
     * @return mixed
     */
