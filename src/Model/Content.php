...
namespace Pmixsolutions\Story\Model;

use Orchestra\Model\User;
use Pmixsolutions\Story\Facades\Story;
...
class Content extends Eloquent
{
     ...
     * @var string
     */
    protected $table = 'pmix_story_contents';
    ...
    public function editUrl()
    {
        ...
        return handles("pmixsolutions::storycms/{$type}s/{$id}/edit");
    }
