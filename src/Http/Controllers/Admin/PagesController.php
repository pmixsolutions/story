...
class PagesController extends ContentController
{
    ...
    public function edit($id = null)
    {
        ...
        return view('pmixsolutions/story::admin.editor', [
            'content' => $content,
            'url'     => handles("pmixsolutions::storycms/pages/{$content->getAttribute('id')}"),
            'method'  => 'PUT',
        ]);
    }
    ...
    public function storeHasSucceed(Content $content, array $input)
    {
        ...
        return redirect(handles("pmixsolutions::storycms/pages/{$content->getAttribute('id')}/edit"));
    }
    ...
    public function deletionHasSucceed(Content $content)
    {
        ...
        return redirect(handles('pmixsolutions::storycms/pages'));
    }
}
